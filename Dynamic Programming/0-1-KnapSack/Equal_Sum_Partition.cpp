...
bool equalSumPartition( vector<ll>w, ll n )
{
    //checking if the sum of elements in the array is even
    ll sum=0;
    sum=sum(w);
...
int main()
{
    ...
    bool partitionExist = equalSumPartition(arr,n);
    if( partitionExist ) cout << "YES\n";
    else cout << "NO\n";
